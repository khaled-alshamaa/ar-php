...
* __التسويق:__ يمكنك دوما المساعدة في إشهار ونشر استخدام Ar-PHP، فيما يلي بعض الطرق للمساعدة في ذلك: إنضم إلى فريق التسويق، توزيع Ar-PHP، نشرة حول مشروع Ar-PHP.
